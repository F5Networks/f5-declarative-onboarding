...
.. list-table::
      ...
      * - Doc Rev
        ...
        * - 2.7
          - Updated the documentation for Declarative Onboarding v1.10.0.  This release contains the following changes: |br| * Added the :ref:`system-class` to the Composing a Standalone declaration page |br| * Added support for disabling autoPhonehome in the System class (see :ref:`system-class`)  |br| *   |br| |br| Issues Resolved: |br| * On BIG-IP 14 and later, revoke license from BIG-IQ does not work |br| * h
          - 12-03-19
