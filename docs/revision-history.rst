...
.. list-table::
      ...
      * - 1.29
        - Updated the documentation for Declarative Onboarding v1.29.0.  This release contains the following changes: |br| *  |br| |br| Issues Resolved: |br| *  Licensing can fail if restnoded restarts during processing.
        - 4-19-22
