...
.. |github| raw:: html
   ...
   <a href="https://github.com/F5Networks/f5-declarative-onboarding/blob/main/dist/do.examples.collection.json" target="_blank">BIG-IP Declarative Onboarding Postman collection</a>
