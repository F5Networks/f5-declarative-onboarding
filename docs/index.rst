...
F5 Declarative onboarding uses a declarative model to bring up a BIG-IP device with all of the required initial settings. A declarative model means you provide a JSON declaration rather than a set of imperative
