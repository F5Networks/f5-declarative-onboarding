 ...
 * @class
 */
class DeprovisionHandler extends ProvisionHandler {
    /**
     * Constructor
     *
    ...
    constructor(declaration, bigIp, eventEmitter, state) {
        super(declaration, bigIp, eventEmitter, state);
        this.isDeprovisioning = true;
    }
}

module.exports = DeprovisionHandler;
